...
def conv1d_unstrided(input, filters, image_shape, filter_shape,
    ...
    r_input_folded = r_input.dimshuffle(0, 1, 3, 2)
    r_input_folded = r_input_folded.reshape(r_input_folded_shape)
    ...
    r_filter_folded_shape = (num_filters, num_input_channels * stride,
                             num_steps)
    r_filters_flipped_folded = r_filters_flipped.dimshuffle(0, 1, 3, 2)
    r_filters_flipped_folded = r_filters_flipped_folded.reshape(
